...
export const LandingHero: React.FC = () => {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-slate-50 px-0 pb-16 pt-10 md:pb-24 md:pt-16">
      {/* Elementos visuais de fundo subtis para criar profundidade sofisticada */}
<div className="absolute inset-x-0 top-0 -z-10 h-[34rem] bg-[radial-gradient(circle_at_top,rgba(224,231,255,0.72),transparent_62%)] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Bloco Superior: Headline & CTAs de Alto Impacto */}
        <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto mb-12 sm:mb-16">
        ...
        <motion.div
          ...
          className="relative z-0 -mt-4 max-w-5xl mx-auto opacity-[0.96] md:-mt-20 [filter:drop-shadow(0_22px_34px_rgb(15_23_42_/_0.14))]"
        >
